...
Dado que la descripción y los criterios de aceptación de todas las Historias de Usuario son extensas se podrán ver en detalle en el siguiente enlace a el GitHub project \footnote{Enlace al listado de HUs: https://github.com/users/Melendo/projects/7/views/10} para facilitar la lectura y fluidez de este documento.
