...
Se presenta el perfil de Víctor en la imagen \ref{fig:Victor}, un \textit{route-setter} cuyo objetivo es gestionar eficientemente el muro y dinamizar a su comunidad.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{./Imagenes/Fuentes/victor.png} 
    \caption{Imagen de la \textit{persona} Víctor}
    \label{fig:Victor}
\end{figure}
...
Dado que la descripción y los criterios de aceptación de todas las Historias de Usuario son extensas se podrán ver en detalle en el siguiente enlace a el GitHub project \ref{https://github.com/users/Melendo/projects/7/views/10} para facilitar la lectura y fluidez de este documento.
