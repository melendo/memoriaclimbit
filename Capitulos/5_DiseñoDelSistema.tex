...
La navegación principal está representada en la figura \ref{fig:menu_navegacion}.

Como puede observarse en la figura \ref{fig:diagrama_flujo_climbit} o en más detalle a través del siguiente enlace\footnote{Diagrama de flujo de ClimbIt:\ https://drive.google.com/file/d/1sS4bsYvnHnPNX0zLyQFiZeIKNnbBn6MV/view?usp=sharing}, la estructura que sigue ClimbIt es una combinación entre una estructura \textit{plana} para las vistas principales y una estructura jerárquica de árbol para las vistas secundarias que nacen de ellas. De esta forma, se garantiza un acceso rápido a todas las funcionalidades principales desde cualquier punto de la raíz de la aplicación, pero manteniendo una disposición organizada del contenido.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{./Imagenes/Fuentes/bottom_nav_bar.png} 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{./Imagenes/Fuentes/Diagrama-Flujo_ClimbIt.png} 
...
\paragraph{Uso de Cards:} La información de los rocódromos (figura~\ref{fig:misRocodromos}) y las rutas se organiza mediante el uso de \textit{cards}. De esta manera podemos unificar los datos relevantes de cada ruta o rocódromo en unidades independientes, ayudando al usuario a procesar la información de manera fragmentada y organizada.
