...
\begin{itemize}   
    ...
    \{imagen detalles de ruta\}, las acciones principales de cambio de estado (\textit{Flash, Completado, Proyecto y Desmarcar}) se han implementado como botones de gran tamaño. Al aumentar el área de contacto y situarlos en la zona central de la pantalla, se reduce el tiempo necesario para realizar la interacción y se minimiza el error de precisión, facilitando su uso incluso en situaciones de fatiga física en las manos tras la escalada.
\end{itemize}
