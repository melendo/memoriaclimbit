...
En este capítulo se explica cómo se ha realizado la automatización de la entrega continua de software y el despliegue de la infraestructura para los diferentes entornos de \textit{ClimbIt}. Se han empleado metodologías de Integración Continua (CI) y Despliegue Continuo (CD) basadas en la filosofía de DevOps, para la revisión de los nuevos cambios en el código y su correcta integración de manera segura.
...
\begin{itemize}
    \item \textbf{Verificación del dominio:} Se configuró en la ruta (\texttt{.well-known/assetlinks.json}) el envío de información para demostrar a Google la propiedad de la aplicación. Esto permite que el dispositivo móvil confíe en la aplicación y la muestre en pantalla completa.
